...
def main():
    ...
    top_cities = ["Birmingham"]
    train_birmingham = get_cities(train_df, top_cities)
    test_birmingham = get_cities(test_df, top_cities)
    cases_train = get_data(process(train_birmingham))
    cases_test = get_data(process(test_birmingham))
    ...
    loc_name = "naivepinn"
    write_loc = "../../../../output/models/pinn_experiments/final_birmingham_pinn_yearcutoff/"
