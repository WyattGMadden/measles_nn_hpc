...
def main():
    ...
    top_cities = ["Liverpool"]
    train_liverpool = get_cities(train_df, top_cities)
    test_liverpool = get_cities(test_df, top_cities)
    cases_train = get_data(process(train_liverpool))
    cases_test = get_data(process(test_liverpool))
    ...
    loc_name = "naivepinn"
    write_loc = "../../../../output/models/pinn_experiments/final_liverpool_pinn_yearcutoff/"
