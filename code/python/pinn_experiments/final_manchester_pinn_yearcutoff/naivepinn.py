...
def main():
    ...
    top_cities = ["Manchester"]
    train_manchester = get_cities(train_df, top_cities)
    test_manchester = get_cities(test_df, top_cities)
    cases_train = get_data(process(train_manchester))
    cases_test = get_data(process(test_manchester))
    ...
    loc_name = "naivepinn"
    write_loc = "../../../../output/models/pinn_experiments/final_manchester_pinn_yearcutoff/"
