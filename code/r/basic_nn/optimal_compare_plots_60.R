...
nn_dat <- read_csv("../../../output/data/basic_nn_optimal_60/basic_nn_preds.csv")
...
ggplot2::ggsave(paste0(save_dir, "rmse_nn_tsir_facet_60.png"),
...
scale_factor <- 2
ggsave(paste0(save_dir, "rmse_reg_and_gain_nn_tsir_k_facet_60.png"),
       figrmseall, 
