...
nn_trans_dat <- list.files("../../../output/models/basic_nn_yearcutoff_minimal", full.names = T) %>% 
...
nn_dat <- list.files("../../../output/models/basic_nn_yearcutoff_minimal/", full.names = T) %>% 
...
write_csv(nn_dat, "../../../output/data/basic_nn_yearcutoff_minimal/basic_nn_preds.csv")
