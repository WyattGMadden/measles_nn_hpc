...
save_dir <- "~/resubmission_nn_temp/birmingham_pinn"


#filter dirs that include "_fit_info"
dirs <- list.files("../../../output/models/pinn_experiments/final_birmingham_pinn_yearcutoff", full.names = TRUE)
...
#read in obs data
train_fit <- arrow::read_parquet("../../../output/models/pinn_experiments/final_birmingham_pinn_yearcutoff/naivepinn_train_predictions.parquet")
